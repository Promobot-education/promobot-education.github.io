# Прямое управление Rooky. Чтение данных с сервоприводов и датчика касания.

<!-- <details style="font-size: 20px; margin-bottom:10px;">
	<summary style="font-size: 20px; color: #2030FF;">Сборка и запуск примера</summary>
	Текс спойлера
</details> -->
...
int main()
{
	...
	while (true)
	{
		...
		// Выведем всю полученную информацию в удобном формате
		printf("========================\n");
